...
import { RoutineImagesInterceptor } from "src/adapter/common/interceptors/image.interceptor";
import { AddRoutineRequestDto } from "src/adapter/dto/routine/AddRoutineRequestDto";
import { ModifyRoutineRequestDto } from "src/adapter/dto/routine/ModifyRoutineRequestDto";
import { Category } from "src/domain/enums/Category";
import { Resolution } from "src/domain/enums/Resolution";
import { MulterFile } from "src/domain/types";
import { AddRoutineResponseDto } from "src/domain/use-cases/routine/add-routine/dtos/AddRoutineResponseDto";
import { GetAllRoutinesByCategoryResponseDto } from "src/domain/use-cases/routine/get-all-routines-by-category/dtos/GetAllRoutinesByCategoryResponseDto";
import { GetAllRoutinesResponseDto } from "src/domain/use-cases/routine/get-all-routines/dtos/GetAllRoutinesResponseDto";
import { GetRoutineDetailResponseDto } from "src/domain/use-cases/routine/get-routine-detail/dtos/GetRoutineDetailResponseDto";
import { ModifyRoutineResponseDto } from "src/domain/use-cases/routine/modify-routine/dtos/ModifyRoutineResponseDto";
import { AddRoutineResponse, GetAllRoutinesByCategoryResponse, GetAllRoutinesResponse, GetRoutineDetailResponse, ModifyRoutineResponse } from "src/domain/use-cases/routine/response.index";
