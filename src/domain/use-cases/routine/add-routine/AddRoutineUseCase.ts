...
import { AddRoutineUsecaseDto } from './dtos/AddRoutineUsecaseDto';
...
export class AddRoutineUseCase
  implements UseCase<AddRoutineUsecaseDto, AddRoutineResponse>
{
  constructor(
  ...
  public async execute({
    ...
    cardnews,
    thumbnail,
  }: AddRoutineUsecaseDto): AddRoutineResponse {
