...
import { GetAllRoutinesUsecaseDto } from './dtos/GetAllRoutinesUsecaseDto';
...
export class GetAllRoutinesUseCase
  implements UseCase<GetAllRoutinesUsecaseDto, GetAllRoutinesResponse>
{
  constructor(
  ...
  public async execute({
    ...
    size,
    resolution,
  }: GetAllRoutinesUsecaseDto): GetAllRoutinesResponse {
