...
@Injectable()
export class SearchVideoByKeywordUseCaseImpl implements SearchVideoByKeywordUseCase {
  constructor(
  ...
  public async execute({
    ...
    const searchResult = await this._youtubeProvider.searchByKeyword(keyword, maxResults, nextPageToken);
