...
import { onboard, signIn, addRecommendedRoutine, authorize, getRecommendedRoutine } from '../request.index';
...
describe('getRecommendedRoutine e2e test', () => {
  ...
  describe('GET v1/recommended-routines/:id before add an recommended routine', () => {
    it('RecommendedRoutineNotFoundException should be thrown', async () => {
      ...
      const res = await getRecommendedRoutine(httpServer, accessToken, '621a6ec7e4490f5c4f189409');
